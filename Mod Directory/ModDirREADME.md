# <em>Mod Directory</em>
  <p> An easy way to browse, see examples of, and get info for mods.</p>
...
## Content Mods
  <p> &nbsp;Files that directly alter the '''vanilla''' Cypress experience. </p>

  <details>
    <summary> &nbsp;Client Mods</summary>
...
### &nbsp;mod_BetterStairs
  A re-port of [Client_Stairs_Modern](https://github.com/FMG793/1.0.16.05_20-Cypress-Mods-And-Deobfuscated-Code/blob/main/mods_NEW/Client_Stairs_Modern.zip) that makes stairs act modern. (Only works with CustomTerrainItemsV2!)
